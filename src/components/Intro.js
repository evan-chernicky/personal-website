...
function Header() {
  ...
  return (
    <header className="dark:bg-black App-header h-screen flex flex-col justify-center items-center w-100 bg-no-repeat	bg-cover bg-center foam" style={{backgroundImage: `url(${foam})`}}>
