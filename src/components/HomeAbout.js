...
function HomeAbout() {
  ...
  return (
    <div className="min-h-screen m-auto items-center relative flex items-center">
        <div className="flex flex-row">
            <div className="relative" style={{width: "40%"}}>
                <div className="image-line"></div>
                <img src={ProfilePic} alt="Evan Chernicky" />
            </div>
            <div className="px-24 text-left text-black dark:text-white" style={{width: "60%"}}>
                <h2 className="mb-8 text-6xl uppercase tracking-wider tracking-in-expand opacity-0">About</h2>
                <div className="max-w-2xl">
                    ...
                    <a href="/about" onClick={(e) => renderPageTransition(e)} className="text-xl border border-black dark:border-white inline-block w-34 py-3 px-7 m-auto hover:border-pink hover:text-pink dark:hover:border-blue dark:hover:text-blue duration-500">RESUME</a>
                </div>
            </div>
        </div>
    </div>
