        ...
        <section id="story" className="flex overflow-hidden mt-14 lg:mt-36" >
                <div className="text-left text-black dark:text-white slide-in-right opacity-0">
                    ...
                    <div className="max-w-2xl">
                        <p className="text-black dark:text-white mb-5">I've been captivated by stories for as long as I can remember. A childhood trip to see the Space Shuttle launch sparked my fascination with exploration and narrative, whether through history podcasts, the lore of Halo, or sketching out novel ideas. That same love for storytelling led me to earn a Communication degree from Denison University.</p>
                        <p className="text-black dark:text-white mb-5">Alongside this, I was drawn to computers as a creative outlet. I built my first website in 8th grade and took an AP Java class in high school. In college, I helped manage my dad’s WordPress site, but it wasn’t until an internship at the creative web agency Model B that I realized I could blend my passion of storytelling with web development. There, I moved from intern to Creative Technologist and web team leader, learning JavaScript, and PHP while building custom WordPress solutions for over 50 clients. </p>
                        <p className="text-black dark:text-white mb-5">To deepen my skills, I attended Flatiron School, where I added React, Ruby, Rails, and SQL to my toolkit. Most recently, I worked as a front-end developer at Shift7 Digital where I led a team of three developers in building a dynamic and responsive web application using tools such as React and Bloomreach CMS. I also played a key role in the major redesign and modernization a Fortune 500 company's outdated website, delivering a sleek and high-performing new experience.</p>
                        <p className="text-black dark:text-white mb-5">Today, I am excited to take my skills and passion for both code and storytelling to the next chapter of my life by helping companies and agencies sell their stories by creating a unique and creative website experience for their customers.</p>
                    </div>
                </div>
            </section>
